...
*    });
*/
	addEvent(this.element,'mouseover', 
		function(){this.className = "TB_Button_Off_Over"},
		false
	);
	addEvent(this.element,'mouseout', 
		function(){this.className = "TB_Button"},
		false
	);
	addEvent(this.element,'click', 
